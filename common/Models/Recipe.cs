...
namespace BenchmarkingSuite.Common.Models
{
	...
	public class Recipe : DatabaseModel
	{
		...
		public Configuration Configuration {
			get { return configuration == null ? configuration = (IsConnectionOpen ? Configuration.FindByID (ConfigurationID) : null) : configuration; }
			set {
		...
		public Device Device {
			get { return device == null ? (device = IsConnectionOpen ? Device.FindByID (DeviceID) : null) : device; }
			set {
				DeviceID = value.ID;
				device = value;
			}
		...
		public Recipe Save (bool ignore = false)
		{
			return Save<Recipe> (ignore);
		}
